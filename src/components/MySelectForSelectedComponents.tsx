...
import s from './MySelected/MySelected.module.css'
import {ArrayCityesType} from "../SelectedComponentsUseMemoTrannig";


type MySelectedPropsType = {
    value: string
    items: ArrayCityesType
    callback: (id: string) => void
}

export const MySelectedForSelectedComponents = React.memo((props: MySelectedPropsType) => {
    ...
    {collapsed && props.items.map(el =>
        <div onMouseEnter={() => HoveredItemOnMouseEnter(el.id)}
